...
namespace NMib::NConcurrency::NPrivate
{
	...
	template <typename t_CReturnValue>
	TCContinuationData<t_CReturnValue>::~TCContinuationData()
	{
		try
		{
			fp_ReportNothingSet();
	...
	template <typename t_CReturnValue>
	void TCContinuationData<t_CReturnValue>::f_SetResult()
	{
	...
	template <typename t_CReturnValue>
	template <typename tf_CResult>
	void TCContinuationData<t_CReturnValue>::f_SetResult(tf_CResult &&_Result)
	{
	...
	template <typename t_CReturnValue>
	template <typename tf_CResult>
	void TCContinuationData<t_CReturnValue>::f_SetException(tf_CResult &&_Result)
	{
	...
	template <typename t_CReturnValue>
	template <typename tf_CResult>
	void TCContinuationData<t_CReturnValue>::f_SetException(TCAsyncResult<tf_CResult> const &_Result)
	{
		DMibRequire(!_Result);
	...
	template <typename t_CReturnValue>
	template <typename tf_CResult>
	void TCContinuationData<t_CReturnValue>::f_SetException(TCAsyncResult<tf_CResult> &_Result)
	{
		DMibRequire(!_Result);
		m_Result.f_SetException(_Result);
		fp_OnResult();
	...
	template <typename t_CReturnValue>
	void TCContinuationData<t_CReturnValue>::f_SetCurrentException()
	{
