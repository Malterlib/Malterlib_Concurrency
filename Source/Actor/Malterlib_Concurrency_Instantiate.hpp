...
{
	extern template NMib::NContainer::TCVector<NException::CExceptionPointer, NMib::NMemory::CAllocator_Heap, NMib::NContainer::CVectorOptionsDefault>::TCVector() noexcept;
