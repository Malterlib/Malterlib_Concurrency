...
namespace NMib::NConcurrency
{
	...
	// Accepts a byte count with binary/decimal suffix or rate@latency (default latency unit: ms).
	// The rate form uses twice the bandwidth-delay product. Empty, default and zero select the transport default.
	// Returns false with o_Error for invalid input.
