...
namespace NMib::NConcurrency
{
	namespace NActorDistributionManagerInternal
	{
		...
		// can lag it after a reconfiguration. An anonymous endpoint (no local certificate) leaves
		...
		NCryptography::CCertificateVerifyOptions fg_VerifyOptionsFromKeySetting(NCryptography::CPublicKeySetting const &_KeySetting, bool _bHasLocalCertificate)
		{
			...
			VerifyOptions.m_AllowedSignatureDigests.f_Insert(NCryptography::fg_GetAutomaticDigestType(_KeySetting));
