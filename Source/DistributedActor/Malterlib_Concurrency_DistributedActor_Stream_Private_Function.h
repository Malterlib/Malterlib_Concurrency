...
namespace NMib::NConcurrency::NPrivate
{
	struct CStreamingFunction
	{
		...
		virtual NConcurrency::TCFuture<NStream::CBinaryStorage> f_Call(CDistributedActorReadStream &_Stream) = 0;
	...
	struct TCStreamingFunction : public CStreamingFunction
	{
		...
		NConcurrency::TCFuture<NStream::CBinaryStorage> f_Call(CDistributedActorReadStream &_Stream) override;
