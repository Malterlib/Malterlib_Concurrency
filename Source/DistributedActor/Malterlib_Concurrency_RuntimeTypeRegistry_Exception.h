...
namespace NMib::NConcurrency
{
	struct CRuntimeTypeRegistryEntry_Exception
	{
		...
		virtual NException::CExceptionPointer f_Consume(NStream::TCBinaryStreamStoragePtr<NStream::CBinaryStreamDefault> &_Stream) = 0;
		...
		virtual void f_Feed(NStream::TCBinaryStreamStorage<NStream::CBinaryStreamDefault> &_Stream, NException::CExceptionBase const &_Exception) = 0;
...
namespace NMib::NConcurrency::NPrivate
{
	...
	struct TCRuntimeTypeRegistryEntry_Exception final : public CRuntimeTypeRegistryEntry_Exception
	{
		...
		NException::CExceptionPointer f_Consume(NStream::TCBinaryStreamStoragePtr<NStream::CBinaryStreamDefault> &_Stream) override;
		...
		void f_Feed(NStream::TCBinaryStreamStorage<NStream::CBinaryStreamDefault> &_Stream, NException::CExceptionBase const &_Exception) override;
