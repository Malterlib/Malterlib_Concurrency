...
namespace NMib::NConcurrency
{
		...
		)
	{
		...
		o_ConfigFiles.m_Files[ConfigFileName].m_Type = bYamlConfig ? CDistributedAppInterfaceServer::EMonitorConfigType_Yaml : CDistributedAppInterfaceServer::EMonitorConfigType_Json;
	}
