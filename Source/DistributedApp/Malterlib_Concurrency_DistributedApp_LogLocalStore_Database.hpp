...
namespace NMib::NConcurrency::NLogStoreLocalDatabase
{
	...
	void CLogGlobalStateKey::f_FeedLexicographic(tf_CStream &_Stream) const
	{
	...
	template <typename tf_CStream>
	void CLogGlobalStateKey::f_ConsumeLexicographic(tf_CStream &_Stream)
	{
		NDatabase::CDatabaseValue::fs_FeedLexicographic(_Stream, m_DbPrefix);
		NDatabase::CDatabaseValue::fs_FeedLexicographic(_Stream, m_Prefix);
	}
	...
	template <typename tf_CStream>
	void CLogGlobalStateValue::f_Stream(tf_CStream &_Stream)
	{
