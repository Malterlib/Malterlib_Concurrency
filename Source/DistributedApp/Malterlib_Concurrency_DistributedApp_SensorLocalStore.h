...
namespace NMib::NConcurrency
{
	struct CDistributedAppSensorStoreLocal : public CActor
	{
		...
		TCFuture<CActorSubscription> f_AddExtraSensorReporter(TCDistributedActorInterface<CDistributedAppSensorReporter> _SensorReporter, CTrustedActorInfo _TrustInfo);
		...
		TCFuture<uint32> f_SnoozeSensors(NContainer::TCSet<CDistributedAppSensorReporter::CSensorInfoKey> _SensorInfoKeys, NTime::CTimeSpan _SnoozeDuration);
