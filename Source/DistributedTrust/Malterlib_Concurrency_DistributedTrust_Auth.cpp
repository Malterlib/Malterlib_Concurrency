...
namespace NMib::NConcurrency
{
		...
		)
	{
		...
		auto fAddFalseResult = [&]
			{
				FactorIDs.f_Insert();
				TCPromise<ICDistributedActorTrustManagerAuthenticationActor::CVerifyAuthenticationReturn> Result{CPromiseConstructNoConsume()};
				(Result <<= ICDistributedActorTrustManagerAuthenticationActor::CVerifyAuthenticationReturn{}) > VerificationResults;
			}
		;
