...
namespace NMib::NConcurrency
{
	...
	public:
		...
		virtual TCFuture<void> f_SetBasicConfig(CBasicConfig const &_BasicConfig) = 0;
		virtual TCFuture<int32> f_GetNewCertificateSerial() = 0;
		virtual TCFuture<CDefaultUser> f_GetDefaultUser() = 0;
		virtual TCFuture<void> f_SetDefaultUser(CDefaultUser const &_DefaultUser) = 0;

		virtual TCFuture<NContainer::TCMap<NStr::CStr, CServerCertificate>> f_EnumServerCertificates(bool _bIncludeFullInfo) = 0;
		virtual TCFuture<CServerCertificate> f_GetServerCertificate(NStr::CStr const &_HostName) = 0;
		virtual TCFuture<void> f_AddServerCertificate(NStr::CStr const &_HostName, CServerCertificate const &_Certificate) = 0;
		virtual TCFuture<void> f_SetServerCertificate(NStr::CStr const &_HostName, CServerCertificate const &_Certificate) = 0;
		virtual TCFuture<void> f_RemoveServerCertificate(NStr::CStr const &_HostName) = 0;
		...
		virtual TCFuture<void> f_AddClient(NStr::CStr const &_HostID, CClient const &_Client) = 0;
		virtual TCFuture<void> f_SetClient(NStr::CStr const &_HostID, CClient const &_Client) = 0;
		...
		virtual TCFuture<CClientConnection> f_GetClientConnection(CDistributedActorTrustManager_Address const &_Address) = 0;
		virtual TCFuture<void> f_AddClientConnection(CDistributedActorTrustManager_Address const &_Address, CClientConnection const &_ClientConnection) = 0;
		virtual TCFuture<void> f_SetClientConnection(CDistributedActorTrustManager_Address const &_Address, CClientConnection const &_ClientConnection) = 0;
		...
		virtual TCFuture<CNamespace> f_GetNamespace(NStr::CStr const &_NamespaceName) = 0;
		virtual TCFuture<void> f_AddNamespace(NStr::CStr const &_NamespaceName, CNamespace const &_Namespace) = 0;
		virtual TCFuture<void> f_SetNamespace(NStr::CStr const &_NamespaceName, CNamespace const &_Namespace) = 0;
		virtual TCFuture<void> f_RemoveNamespace(NStr::CStr const &_NamespaceName) = 0;

		virtual TCFuture<NContainer::TCMap<CPermissionIdentifiers, CPermissions>> f_EnumPermissions(bool _bIncludeFullInfo) = 0;
		virtual TCFuture<CPermissions> f_GetPermissions(CPermissionIdentifiers const &_Identity) = 0;
		virtual TCFuture<void> f_AddPermissions(CPermissionIdentifiers const &_Identity, CPermissions const &_Permissions) = 0;
		virtual TCFuture<void> f_SetPermissions(CPermissionIdentifiers const &_Identity, CPermissions const &_Permissions) = 0;
		virtual TCFuture<void> f_RemovePermissions(CPermissionIdentifiers const &_Identity) = 0;

		virtual TCFuture<NContainer::TCMap<NStr::CStr, CUserInfo>> f_EnumUsers(bool _bIncludeFullInfo) = 0;
		virtual TCFuture<CUserInfo> f_GetUserInfo(NStr::CStr const &_User) = 0;
		virtual TCFuture<void> f_AddUser(NStr::CStr const &_User, CUserInfo const &_UserInfo) = 0;
		virtual TCFuture<void> f_SetUserInfo(NStr::CStr const &_User, CUserInfo const &_UserInfo) = 0;
		virtual TCFuture<void> f_RemoveUser(NStr::CStr const &_User) = 0;
