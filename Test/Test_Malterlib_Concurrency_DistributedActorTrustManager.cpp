		...
		void f_DoTests()
		{
			DMibTestSuite("Basic")
			{
				...
				;
				{
					...
					ServerTrustManager(&CDistributedActorTrustManager::f_AddListen, ServerAddress);
...

				{
					...
					ServerTrustManager(&CDistributedActorTrustManager::f_RemoveListen, OldServerAddress);
...

				{
					...
					ServerTrustManager(&CDistributedActorTrustManager::f_RemoveClient, HostID);
